---
title: '231B Section 1: Intro to R, probability and '
...
* I will draw a lot on the material produced by Guadalupe Tuñón (and, for this section, on the material used on the 2016 version of the EGAP learning days). 
...
Sections are *hands-on*: you will be expected to code on your own computers and to group with your colleagues. For some sections, we will be using codeshare: http://www.codeshare.io/NQ7Gn
...
matrix(1:12, 4, 3)             # Make a 4X2 matrix with numbers 1:12
...
We will draw several random samples of 8 observations (n) *without* replacement 
...
So far, $n=8$. We now need a new simulation that adds a new step: we need to vary the size of n. Remember `r N`
